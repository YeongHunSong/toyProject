...
//
//        List<Post> postList = postRepository.findAll(null, null, null);
//
...
//        Post findPost2 = postRepository.findByPostId(post2.getPostId());
//
//        List<Post> findPostTitle1 = postRepository.findAll(cond1, null, null);
//        List<Post> findPostTitle2 = postRepository.findAll(cond2, null, null);
//        List<Post> findPostTitle3 = postRepository.findAll(cond3, null, null);
//        List<Post> findPostTitle4 = postRepository.findAll(cond4, null, null);
//
